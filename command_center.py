...
MODULES = [
    ...
    ("/royalty-recovery/cases", "Royalty Recovery Cases", "Turn recovery insights into tracked cases with evidence and deadlines.", "preview", None),
    ...
    ("/deal-room", "Deal Room", "Splits, producer and feature agreements, document vault, deal board.", "preview", _NOT_LEGAL),
    ...
    ("/trust-score", "Trust Score", "One verifiable readiness score for partners, labels, and supervisors.", "preview", None),
    ("/artist-twin", "Artist Twin", "A private AI agent trained only on data you approve.", "preview", None),
