/* The membership rack: touch, and the leave.
   ...
   The screens are links whose glass shows a drift of particles until
   they are pointed at (CSS :hover / :focus-visible), when the particles
   come together and the tier renders. Two things CSS cannot do alone:
   ...
   query decides who gets the particles, because a touchscreen laptop
