...
export async function createDemoShop(): Promise<SeedOutcome> {
  ...
  const tools = [
    ...
    { toolNumber: 5, toolClass: "SPOT_DRILL", description: '1/2" 90° spot drill', diameter: 0.5, flutes: 2, fluteLength: 0.4, overallLength: 2.5, stickout: 1, maxRPM: 6000, chiploadMin: 0.002, chiploadMax: 0.004, sfmMin: 250, sfmMax: 400, costPerTool: 30, expectedLifeMinutes: 400 },
    { toolNumber: 6, toolClass: "DRILL", description: '#7 (0.201") carbide drill', diameter: 0.201, flutes: 2, fluteLength: 1.5, overallLength: 3, stickout: 1.9, maxRPM: 8100, chiploadMin: 0.003, chiploadMax: 0.006, sfmMin: 250, sfmMax: 400, costPerTool: 24, expectedLifeMinutes: 180 },
    { toolNumber: 7, toolClass: "CHAMFER_MILL", description: '1/2" 90° chamfer mill', diameter: 0.5, flutes: 4, fluteLength: 0.5, overallLength: 2.5, stickout: 1.1, maxRPM: 8100, chiploadMin: 0.001, chiploadMax: 0.003, sfmMin: 500, sfmMax: 900, costPerTool: 38, expectedLifeMinutes: 300 },
  ];
