...
STANDBY_FRAMES = [('Light Designer', 'Looks programmed against the song, with real DMX out'), ('Stage Plot', 'The backline and the input list, drawn once'), ('Tour Board', 'Every date, hold and confirmation in one row'), ('Passports', 'The technical record a venue reads before you arrive')]
STANDBY_REELS = [('cues', 'Cues', ('lights', 'rigged', 'patched', 'cued', 'plotted', 'passported'))]
STANDBY_TIPS = ('channels', 'Channels', ['Programme looks against the song', 'Draw the backline once', 'Patch the rig, reuse it', 'Send the venue your passport'])
STANDBY_TICKER = ('passport', 'Passport version', ['Light Designer', 'Stage Plot', 'Tour Board', 'Passports', 'Live'])
STANDBY_CINE = ('stage', 'The stage')
...
STANDBY_IMAGES = tuple("static/img/standby/stage-%d.webp" % n for n in (1, 2, 3, 4))
STANDBY_IMAGE_V = 1
