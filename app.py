...
def create_app():
    ...
    @app.route("/conflicts")
    def conflicts():
        """Retired (walk, 2026-09-20). It read the demo's invented songs
        and answered "No rights conflicts detected" for every real
        account, while the money queue on the same account listed the
        missing songwriters and split sheets. The queue is the page."""
        return redirect("/money-queue")
