...
- Access: Artist tier and above ("/conflicts" in _PRO_PATHS). Team seats: "/conflicts" is in team_areas.EXTRA["business"]. The sidebar badged this real page Sample until 2026-09-23, when "conflicts" joined hubs._BASE_LIVE (with money-queue and discover; tests/test_real_money.py).
