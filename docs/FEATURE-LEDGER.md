...
- The All Tools line (command_center.MODULES) said "Live Spotify followers, popularity, top tracks, and Deezer fans". Spotify retired followers, popularity and genres for apps like this one (2026-09-15), and Deezer fans and top tracks need SPOTIFY_CLIENT_ID/SECRET, so since 2026-09-23 it names what the page reads without them: followers and monthly listeners from Soundcharts, a YouTube channel the owner names, and clicks on the account's own smart links. The sidebar line said "Daily follower and popularity snapshots"; readings are taken when the page is opened, so it says "Follower and listener readings kept over time". The Artist Twin's audience section now reads followers alone (it waited for a popularity reading that no longer comes) and no longer promises popularity or Deezer fans.
