...
has quota, or that the sending domain is verified. Where a real round
trip exists - /mail/diag sends, /storage/diag writes an object and reads
it back - the row links it and says what it proves. A rotated Stripe
    ...
    return [
        ("Email", "Nothing reaches anybody without this.", [
            dict(name="Sending (Resend)",
                 ...
                 probe="/mail/diag", proof="sends a real message"),
        ...
        ("Files", "Where uploads live.", [
            dict(name="Object storage (R2)",
                 ...
                 probe="/storage/diag",
                 proof="writes an object, signs a URL, reads it back, deletes it"),
        ...
        ("Music data", "Where the numbers on Pulse and Signal come from.", [
            dict(name="Spotify",
                 ...
                 probe="/presave/diag", proof="checks the OAuth round trip"),
            ...
            dict(name="Soundcharts",
                 ...
                 probe="/signal/admin/data-sources",
                 proof="names which adapter serves each capability"),
        ...
        ("Audio", "The key, the splitter, and one flag per lane.", [
            dict(name="ElevenLabs key", on=_present("ELEVENLABS_API_KEY"),
                 ...
                 probe="/admin/audio", proof="probes the vendor live"),
            dict(name="Stem splitting", on=_present("STEMSPLIT_API_KEY"),
                 env=["STEMSPLIT_API_KEY"], unlocks="Studio Split.",
                 probe="/rack/studio-split/diag", proof="asks the vendor"),
        ] + _flags()),
