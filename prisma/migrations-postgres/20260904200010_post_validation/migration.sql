...
CREATE TABLE "PostValidation" (
  ...
  "revokedReason" TEXT,
  CONSTRAINT "PostValidation_pkey" PRIMARY KEY ("id")
);
CREATE INDEX "PostValidation_organizationId_postId_machineId_idx" ON "PostValidation"("organizationId", "postId", "machineId");
ALTER TABLE "PostValidation" ADD CONSTRAINT "PostValidation_machineId_fkey" FOREIGN KEY ("machineId") REFERENCES "Machine"("id") ON DELETE CASCADE ON UPDATE CASCADE;
