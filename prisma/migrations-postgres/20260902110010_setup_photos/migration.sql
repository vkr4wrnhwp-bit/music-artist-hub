...
ALTER TABLE "UploadedAsset" ADD COLUMN "setupId" TEXT;
CREATE INDEX "UploadedAsset_setupId_idx" ON "UploadedAsset"("setupId");
ALTER TABLE "UploadedAsset" ADD CONSTRAINT "UploadedAsset_setupId_fkey" FOREIGN KEY ("setupId") REFERENCES "Setup"("id") ON DELETE SET NULL ON UPDATE CASCADE;
