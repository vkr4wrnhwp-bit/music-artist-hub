...
CREATE TABLE "NCExportAuthorization" (
    ...
    CONSTRAINT "NCExportAuthorization_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "NCExportAuthorization_ncProgramId_fkey" FOREIGN KEY ("ncProgramId") REFERENCES "NCProgram" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
