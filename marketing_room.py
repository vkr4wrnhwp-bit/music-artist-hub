...
# 15% under the narrow default (owner, 2026-09-22): the story window is
# about 316px wide at a desktop plate and "Announcements" did not fit.
# Sized from the glass, not from taste: the story window is 25.34cqw wide,
# "Announcements" is 13 characters of Archivo bold at ~0.68em each, and it
# has to fit inside 94% of the window. That is 2.55cqw - about 25% under
# the narrow default. The owner asked for 15%; at 15% the word measured
# one pixel wider than the glass and broke in the middle.
STANDBY_SIZE = ('clamp(16px, 2.55cqw, 40px)', 'clamp(9px, 1cqw, 14px)')
